...
class test_meter(unittest.TestCase):
    ...
    def setUp(self):
        self.simple_meters = [  (2,4), (3,4), (4,4),
                                                        (6,4), (8,4), (5,4),
                                                        (2,2), (1,2), (6,4)]

        self.compound_meters = [ (3,4), (6,4), (9,4), (12,4),
                                                         (3,8), (6,8), (9,8), (12,8),
                                                         (3,16), (6,16), (9,16), (12,16) ]

        self.asymmetrical_meters = [ (3,4), (5,4), (7,4), (11,4),
                                                                 (1,8), (3,8), (5,8), (7,8),
                                                                 (3,16), (11,16), (15,16), (17,16)]

    def test_valid_beat_duration(self):
        for x in [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]:
    ...
    def test_is_valid_meter(self):
        list(map(lambda x: self.assertTrue(meter.is_valid(x),\
                                        ...
                                        self.compound_meters + self.simple_meters))
