...
class test_chords(unittest.TestCase):
    ...
    def test_tonic(self):
        ...
        list(map(lambda x: self.assertEqual(chords.tonic(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_tonic7(self):
        ...
        list(map(lambda x: self.assertEqual(chords.tonic7(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_dominant(self):
        ...
        list(map(lambda x: self.assertEqual(chords.dominant(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_dominant7(self):
        ...
        list(map(lambda x: self.assertEqual(chords.dominant7(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_subdominant(self):
        ...
        list(map(lambda x: self.assertEqual(chords.subdominant(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_subdominant7(self):
        ...
        list(map(lambda x: self.assertEqual(chords.subdominant7(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_submediant(self):
        ...
        list(map(lambda x: self.assertEqual(chords.submediant(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_submediant7(self):
        ...
        list(map(lambda x: self.assertEqual(chords.submediant7(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_supertonic(self):
        ...
        list(map(lambda x: self.assertEqual(chords.supertonic(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_supertonic7(self):
        ...
        list(map(lambda x: self.assertEqual(chords.supertonic7(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_mediant(self):
        ...
        list(map(lambda x: self.assertEqual(chords.mediant(x), tonic_dict[x]), list(tonic_dict.keys())))
    ...
    def test_mediant7(self):
        ...
        list(map(lambda x: self.assertEqual(chords.mediant7(x), tonic_dict[x]), list(tonic_dict.keys())))

    def test_determine_triad(self):
        self.chordsTest([ [["A minor triad", "C major sixth, second inversion"], ["A", "C", "E"]],\
                                          [["C major sixth", "A minor triad, first inversion"], ["C", "E", "A"]],\
                                          [['C major sixth, first inversion', "A minor triad, second inversion"], ["E", "A", "C"]],\
                                          [["C major triad"], ["C", "E", "G"]],\
                                          [["E diminished triad", 'G minor sixth, second inversion'], ["E", "G", "Bb"]],\
                                          [["F augmented triad"], ["F", "A", "C#"]],\
                                          [["C suspended fourth triad", "F suspended second triad, second inversion"], ["C", "F", "G"]],\
                                          [["F suspended second triad", "C suspended fourth triad, first inversion"], ["F", "G", "C"]],\
                                          [["C suspended second triad", "G suspended fourth triad, first inversion"], ["C", "D", "G"]],\
                                          [["F suspended second triad, first inversion", "C suspended fourth triad, second inversion"],\
                                          ["G", "C", "F"]]],\
    ...
    def test_determine_seventh(self):
        ...
        self.chordsTest([[["C major seventh"], ["C", "E", "G", "B"]],\
                [["C major seventh, first inversion"], ["E", "G", "B", "C"]],\
                [["C major seventh, second inversion"], ["G", "B", "C", "E"]],\
                [["C major seventh, third inversion"], ["B", "C", "E", "G"]],\
                [["C minor seventh", "Eb major sixth, third inversion"], ["C", "Eb", "G", "Bb"]],\
                [["C dominant seventh"], ["C", "E", "G", "Bb"]],\
                [["C minor/major seventh"], ["C", "Eb", "G", "B"]],\
                [["C half diminished seventh", "Eb minor sixth, third inversion"], ["C", "Eb", "Gb", "Bb"]],\
                [["C diminished seventh"], ["C", "Eb", "Gb", "Bbb"]],\
                [["C minor/major seventh"], ["C", "Eb", "G", "B"]],\
                [["C augmented major seventh"], ["C", "E", "G#", "B"]],\
                [["C augmented minor seventh"], ["C", "E", "G#", "Bb"]],\
                [["C minor sixth", "A half diminished seventh, first inversion"], ["C", "Eb", "G", "A"]],\
                [[ "C minor sixth, first inversion", "A half diminished seventh, second inversion"], ["Eb", "G", "A", "C"]],\
                [[ "C minor sixth, second inversion", "A half diminished seventh, third inversion"], ["G", "A", "C", "Eb"]],\
                [["A half diminished seventh", "C minor sixth, third inversion"] , ["A", "C", "Eb", "G"]]],\
    ...
    def chordsTest(self, values, what_func, what_desc):
        list(map(lambda x: [self.assertTrue(y in what_func(x[1]),\
                                "The %s '%s' should be in '%s', but is not." % \
                                (what_desc, y, what_func(x[1]))) for y in x[0]], values))\
    ...
    def test_determine(self):
        ...
        list(map(lambda x: self.assertEqual("C" + \
                ...
                [x for x in list(chords.chord_shorthand.keys()) if \
                        x != '5']))
