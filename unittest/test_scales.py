...
class test_scales(unittest.TestCase):
    ...
    def scaleTest(self, answer_dict, scale_func, name):
        list(map (lambda x: self.assertEqual(answer_dict[x], scale_func(x),\
                                "The %s of %s is not %s, expecting %s" % (name, x,\
                                scale_func(x), answer_dict[x])), list(answer_dict.keys())))


    def test_diatonic(self):
        self.scaleTest({"C" : ["C", "D", "E", "F", "G", "A", "B"],
                                        "E" : ["E", "F#", "G#", "A", "B", "C#", "D#"],
                                        "B" : ["B", "C#", "D#", "E", "F#", "G#", "A#"]},
