...
class test_intervals(unittest.TestCase):
    ...
    def test_seconds(self):
        ...
        list(map(lambda x: self.assertEqual(secs_fsharp[x],\
                        intervals.second(x, "F#"),"Invalid second for %s in key F#"\
                        % x), list(secs_fsharp.keys())))
    ...
    def test_minor_unison(self):
        ...
        for x in list(minors.keys()):
            self.assertEqual(minors[x], intervals.minor_unison(x),\
                    "The minor unison of %s is not %s, expecting %s" % (x, intervals.minor_unison(x), minors[x]))
    ...
    def test_minor_fourth(self):
        ...
        for x in list(minors.keys()):
            self.assertEqual(minors[x], intervals.minor_fourth(x),\
                    "The minor fourth of %s is not %s, expecting %s" % (x, intervals.minor_fourth(x), minors[x]))
    ...
    def test_major_fifth(self):
        ...
        for x in list(majors.keys()):
            self.assertEqual(majors[x], intervals.major_fifth(x),\
                    "The major fifth of %s is not %s, expecting %s" % (x, intervals.major_fifth(x), majors[x]))
