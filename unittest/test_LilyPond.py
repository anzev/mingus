...
class test_LilyPond(unittest.TestCase):
    ...
    def setUp(self):
        ...
        list(map(lambda x: self.tbar.place_notes(NoteContainer(x), 6), ["C", "E", "G", "B", "C", "E"]))
    ...
    def test_to_pdf(self):
        self.assertTrue(LilyPond.to_pdf("{ %s }" % LilyPond.from_NoteContainer(NoteContainer("C"), value.dots(8)), "pdftest first test"))
