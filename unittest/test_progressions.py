...
class test_progressions(unittest.TestCase):
    ...
    def test_substitute_minor_for_major(self):
        self.assertTrue("IM" in progressions.substitute_minor_for_major(["VIm"], 0))
        self.assertTrue("I" in progressions.substitute_minor_for_major(["VI"], 0))
        self.assertTrue("IM7" in progressions.substitute_minor_for_major(["VIm7"], 0))
        self.assertTrue("bIM7" in progressions.substitute_minor_for_major(["bVIm7"], 0))
        self.assertTrue("#IM7" in progressions.substitute_minor_for_major(["#VIm7"], 0))

    def test_substitute_major_for_minor(self):
        self.assertTrue("VIm" in progressions.substitute_major_for_minor(["IM"], 0))
        self.assertTrue("VIm7" in progressions.substitute_major_for_minor(["IM7"], 0))
        self.assertTrue("VI" in progressions.substitute_major_for_minor(["I"], 0))
        self.assertTrue("bVI" in progressions.substitute_major_for_minor(["bI"], 0))
        self.assertTrue("#VI" in progressions.substitute_major_for_minor(["#I"], 0))

    def test_substitute_diminished_for_diminished(self):
        self.assertTrue(progressions.substitute_diminished_for_diminished(["VII"], 0) ==
