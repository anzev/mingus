...
================================================================================
    ...
    some of the events (`init`, `play_event`, `stop_event`, `cc_event`, `instr_event`)
...
can be attached to the Sequencer."""
    ...
    # Events
    # Implement some of these functions when subclassing
...
See the MIDI specification for more information."""
    ...
    def play_Note(self, note, channel = 1, velocity = 100):
        """Plays a Note object on a channel with a \
