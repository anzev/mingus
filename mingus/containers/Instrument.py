...
class Instrument:
    """The Instrument class is pretty self explanatory. Instruments \
can be used with [refMingusContainersTrack Tracks] to define which \
instrument plays what, with the added bonus of checking whether the \
entered notes are in the range of the instrument.

It's probably easiest to subclass your own Instruments (see \
[refMingusContainersPiano Piano] and [refMingusContainersGuitar Guitar] \
for examples)."""
...
of two [refMingusContainersNote Notes] or note strings."""
        if type(range[0]) == str:
