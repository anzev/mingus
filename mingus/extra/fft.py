...
def find_Note(data, freq, bits):
    """Gets the frequencies, feeds them to find_notes and the \
returns the Note with the highest amplitude."""
...
def analyze_chunks(data, freq, bits, chunksize = 512):
    """Cuts the one channel data in chunks and analyzes them separately. \
...
This function returns a list [(Note, chunks)] where chunks is the number of chunks \
